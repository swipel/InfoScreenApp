...
public class HttpAsyncTaskPut extends HttpAsyncTask {

    public HttpAsyncTaskPut(TaskCompleted listener, Object obj, String url) {
    ...
    protected Object doInBackground(String... strings) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                Log.e("Failede updateing", responseCode + "");
            }
            return obj;
